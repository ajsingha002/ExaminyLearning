const model = require('../models/Exams');
...
let getExamsByCourseId = async (body) => {
	try {
		let query;
		if(body === null)
			query = null;
...
let getExamsByUserId = async (body) => {
	try {
		let query;
		if(body === null)
			query = null;
...
module.exports = {
	...
	update : update,
	del : del,
	getExamsByCourseId : getExamsByCourseId,
	getExamsByUserId : getExamsByUserId
}